package velo.uned.velocimetro.preferencias;
...
public class NumberPickerPreference extends Preference implements
    ...
    int mCurrentValue = DEFAULT_VALUE;
    String[] mValues;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCurrentValue = attrs.getAttributeIntValue(null, "default", DEFAULT_VALUE);
    ...
    protected void onSetInitialValue(boolean restorePersistedValue, Object defaultValue) {
        ...
        if (restorePersistedValue) {
            ...
            mCurrentValue = this.getPersistedInt(mCurrentValue);
        } else {
